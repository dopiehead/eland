...
$insert_query = "INSERT INTO products 
    (poster_id, poster_type, product_name, product_price, product_image, product_details, product_category, product_location, product_address, product_color, quantity_sold, product_quantity, gift_picks, sold, product_views, product_likes, product_rating, product_discount, featured_product, product_date, status) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = $conn->prepare($insert_query);
$stmt->bind_param("issssssssissiiiisisi", 
    $poster_id, $poster_type, $product_name, $product_price, $imagePath, $product_details, $product_category, $product_location, $product_address, $product_color, $quantity_sold, $product_quantity, $gift_picks, $sold, $product_views, $product_likes, $product_rating, $product_discount, $featured_product, $product_date, $status);
